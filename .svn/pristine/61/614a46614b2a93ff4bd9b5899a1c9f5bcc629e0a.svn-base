...
//    }
	...
	@Override
	public List<CalendarVO> mainlist(Map<String, Object> map) {
		 return calendarMapper.mainlist(map);
	}
	
	@Override
	public String getBoarUpdateAuth(HashMap<String, String> authParam) {
		// TODO Auto-generated method stub
		 return calendarMapper.getBoarUpdateAuth(authParam);
	}


	@Override
	public String getBoarFileAuth(HashMap<String, String> authParam) {
		// TODO Auto-generated method stub
		 return calendarMapper.getBoarFileAuth(authParam);
	}
}
