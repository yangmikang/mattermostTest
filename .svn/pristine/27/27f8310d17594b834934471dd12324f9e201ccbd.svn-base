...
public class UploadServiceImpl implements UploadService {
    ...
    // 다중 파일 업로드 - 새 그룹 추가 
    @Override
    public long multiImageUpload(MultipartFile[] multipartFiles,String fileType) {
        long fileGroupNo = 0L;
        int result = 0;
        ...
        for (MultipartFile multipartFile : multipartFiles) {
            try {
                ...
                if (dotIdx > -1) {
                	ext = originalName.substring(dotIdx); // ".jpg"
                ...
                fileDetailVO.setFileOriginalName(baseName);
    ...
    @Override
    public void appendFilesToGroup(long fileGroupNo, MultipartFile[] multipartFiles,String fileType) {
        String folder = getFolder();  // yyyy/MM/dd
