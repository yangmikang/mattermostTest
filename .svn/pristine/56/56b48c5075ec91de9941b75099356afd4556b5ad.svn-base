...
public class UserServiceImpl implements UserService {
	...
	@Override
	public boolean checkUsername(String username) throws SQLException, IOException {
	...
	@Override
    public void upsertBoardAuth(UserVO userVO) {
		userMapper.callUpsertBoardAuth(userVO);
    }

	@Override
	public int updateBoardMasterName(String boardMasterCode, String boardMasterName) {
		return userMapper.updateBoardMasterName(boardMasterCode, boardMasterName);
	}
	
	@Override
	public int updateBoardUseYn(String boardMasterCode, String boardUseYn) {
	    return userMapper.updateBoardUseYn(boardMasterCode, boardUseYn);
	}

	@Override
	public void removeAdminRole(String id) {
		userMapper.removeAdminRole(id);
	}

	@Override
	public String getBoardReadAuth(HashMap<String, String> authParam) {
		return userMapper.getBoardReadAuth(authParam);
	}

	@Override
	public String getBoardMasterCodeByLink(String boardLink) {
		return userMapper.getBoardMasterCodeByLink(boardLink);
	}

	@Override
	public String getBoardMasterCodeByBoardCode(String boardCode) {
		return userMapper.getBoardMasterCodeByBoardCode(boardCode);
	}
