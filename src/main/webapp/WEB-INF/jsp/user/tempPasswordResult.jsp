				...
				<div class="inner">
					...
					<nav class="breadcrumb-wrap" aria-label="브레드크럼">
						<ol class="breadcrumb">
							...
							<li><a href="#" class="txt">Your Temporary Password</a></li>
						</ol>
					</nav>
					<!-- breadcrumb -->
					<!-- 페이지 타이틀 영역 -->
					<div class="visual-area">
						<h2 class="h-tit">Your Temporary Password</h2>
					...
					<div class="conts-wrap">
						<div class="conts-wrap log-in-box">
							<div class="txt-box bg-white-login">
									...
									<h4 class="box-tit1">Your Temporary Password</h4>
									<p>Please log in and change your password immediately.</p>
									<div class="box-cnt">
										<div class="box-sec">
											<div class="find-id-box">
												<p>Your Temporary Password is &#58; 
													<strong class="form-conts">${tempPassword}</strong>
												</p>
											</div>
