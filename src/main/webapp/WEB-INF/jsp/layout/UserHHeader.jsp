										...
										<div class="drop-menu">
											<div class="drop-in">
												...
												<ul class="drop-list">
													...
													<li><a href="#" class="item-link ico-setting" onclick="location.href='${pageContext.request.contextPath}/userStats.do'"> User Usage Statistics</a></li>
												</ul>
											</div>
										</div>
									</div>
						...
						<div class="gnb-menu">
							...
							<div class="submenu-wrap">
								...
								<div class="gnb-sub-list" id="mGnb-anchor3">
									<h3 class="sub-title">Programs</h3>
									<ul>										
										<c:forEach items="${menuList }" var="list">
											<c:if test="${list.board_order_group == '3' }">
												<li onclick="location.href='${pageContext.request.contextPath}${list.board_link}'"><a href="#" class="gnb-sub-trigger">${list.board_master_name }</a></li>
								...
								<div class="gnb-sub-list" id="mGnb-anchor5">
									<h3 class="sub-title">Members Area</h3>
									<ul>										
										<c:forEach items="${menuList }" var="list">
											<c:if test="${list.board_order_group == '5' }">
												<li onclick="location.href='${pageContext.request.contextPath}${list.board_link}'"><a href="#" class="gnb-sub-trigger">${list.board_master_name }</a></li>
...
document.querySelector('.btn-navi.all').addEventListener('click', () => {
	  ...
	  if (nav.classList.contains('is-open')) {
	    const anchors = document.querySelectorAll('.gnb-menu a[href^="#mGnb-anchor"]');
...
<script>
document.querySelectorAll('.gnb-main-trigger').forEach(anchor => {
  anchor.addEventListener('click', function(e) {
    e.preventDefault();
    document.querySelectorAll('.gnb-main-trigger').forEach(link => link.classList.remove('active'));
