 ...
 */
public class EgovPiOthersExcepHndlr implements ExceptionHandler {

	private static final Logger LOGGER = LoggerFactory.getLogger(EgovPiOthersExcepHndlr.class);
