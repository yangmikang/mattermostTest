...
public class StatisController {
		 ...
		 * @ResponseBody
		 * 
		 * @RequestMapping(value="/monthlyTotal.do",method = RequestMethod.GET) public
		 * List<StatisVo> getMonthlyTotalRequests() {
		 * 
		 * List<StatisVo> statisVoList = statisService.getMonthlyTotalRequests(); return
		 * statisVoList; }
		 * 
		 * // 일별 전체 요청 수
		 * 
		 * @ResponseBody
		 * 
		 * @RequestMapping(value="/dailyTotal.do",method = RequestMethod.GET) public
		 * List<StatisVo> getDailyTotalRequests() { List<StatisVo> statisVoList =
		 * statisService.getDailyTotalRequests(); return statisVoList; }
		 * 
		 * // 역할별 일별 요청 수
		 * 
		 * @ResponseBody
		 * 
		 * @RequestMapping(value="/dailyByRole.do",method = RequestMethod.GET) public
		 * List<StatisVo> getDailyRequestsByRole() { List<StatisVo> statisVoList =
		 * statisService.getDailyRequestsByRole(); return statisVoList; }
		 * 
		 * // 역할별 월별 요청 수
		 * 
		 * @ResponseBody
		 * 
		 * @RequestMapping(value="/monthlyByRole.do",method = RequestMethod.GET) public
		 * List<StatisVo> getMonthlyRequestsByRole() { List<StatisVo> statisVoList =
		 * statisService.getMonthlyRequestsByRole(); return statisVoList; }
		 */
