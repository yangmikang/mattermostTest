...
//		}
	...
	@RequestMapping(value = "/networkMain.do", method = RequestMethod.GET)
	public ModelAndView networkMain(ModelMap model, HttpServletRequest request, HttpServletResponse response)
			throws IOException, Exception {

		ModelAndView view = new ModelAndView();
		view.setViewName("view/network_main");

		return view;
	}
	
	@RequestMapping(value = "/contactus.do", method = RequestMethod.GET)
	public ModelAndView contactus(ModelMap model, HttpServletRequest request, HttpServletResponse response, HttpSession session)
			throws IOException, Exception {
		
		ModelAndView view = new ModelAndView();
		UserVO user = (UserVO) session.getAttribute("loggedInUser");
	    model.addAttribute("user", user);
		view.setViewName("view/contactus");
	...
	public String sendMail(HttpServletRequest request, 
	        ...
	        @RequestParam("attachments") MultipartFile[] attachments,  // 다중 첨부
	        @RequestParam("g-recaptcha-response") String recaptchaResponse,
	        Model model
	) {
		
		String secretKey = "6LcVc5YrAAAAABvCRJpWt7J3J4MQDjK_z9qa6fLU";
	    ...
	    try {
	        ...
	        if (!success) {
	            request.setAttribute("errorMsg", "CAPTCHA verification failed.");
	            return "contactForm"; // 다시 폼으로
	        }

	    } catch (Exception e) {
	        e.printStackTrace();
	        request.setAttribute("errorMsg", "CAPTCHA verification error.");
	        return "contactForm";
	    }
	    ...
	    try {
	        success = mainService.sendMailWithAttachments(fromEmail, toEmail, subject, content, userName, attachments);
	    } catch (Exception e) {
	        e.printStackTrace();
	    }

	    model.addAttribute("result", success ? "mail success" : "mail fail");
	    return "view/mailResult";
	}

	@RequestMapping(value = "/daejeon.do", method = RequestMethod.GET)
	public ModelAndView daejeon(ModelMap model, HttpServletRequest request, HttpServletResponse response)
			throws IOException, Exception {
		
		ModelAndView view = new ModelAndView();
		view.setViewName("view/daejeon");
		
		return view;
	}
	@RequestMapping(value = "/dortmund.do", method = RequestMethod.GET)
	public ModelAndView dortmund(ModelMap model, HttpServletRequest request, HttpServletResponse response)
			throws IOException, Exception {
		
		ModelAndView view = new ModelAndView();
		view.setViewName("view/dortmund");
		
		return view;
	}
	@RequestMapping(value = "/forumsSeminars.do", method = RequestMethod.GET)
	public ModelAndView forumsSeminars(ModelMap model, HttpServletRequest request, HttpServletResponse response)
			throws IOException, Exception {
		
		ModelAndView view = new ModelAndView();
		view.setViewName("view/forumsSeminars");
		
		return view;
	}
	@RequestMapping(value = "/jointProjects.do", method = RequestMethod.GET)
	public ModelAndView jointProjects(ModelMap model, HttpServletRequest request, HttpServletResponse response)
			throws IOException, Exception {
		
		ModelAndView view = new ModelAndView();
		view.setViewName("view/jointProjects");
		
		return view;
	}
	@RequestMapping(value = "/leadersAssembly.do", method = RequestMethod.GET)
	public ModelAndView leadersAssembly(ModelMap model, HttpServletRequest request, HttpServletResponse response)
			throws IOException, Exception {
		
		ModelAndView view = new ModelAndView();
		view.setViewName("view/leadersAssembly");
		
		return view;
	}
	@RequestMapping(value = "/logo.do", method = RequestMethod.GET)
	public ModelAndView logo(ModelMap model, HttpServletRequest request, HttpServletResponse response)
			throws IOException, Exception {
		
		ModelAndView view = new ModelAndView();
		view.setViewName("view/logo");
		
		return view;
	}
	@RequestMapping(value = "/malaga.do", method = RequestMethod.GET)
	public ModelAndView malaga(ModelMap model, HttpServletRequest request, HttpServletResponse response)
			throws IOException, Exception {
		
		ModelAndView view = new ModelAndView();
		view.setViewName("view/malaga");
		
		return view;
	}
	@RequestMapping(value = "/montgomery.do", method = RequestMethod.GET)
	public ModelAndView montgomery(ModelMap model, HttpServletRequest request, HttpServletResponse response)
			throws IOException, Exception {
		
		ModelAndView view = new ModelAndView();
		view.setViewName("view/montgomery");
		
		return view;
	}
	@RequestMapping(value = "/overview.do", method = RequestMethod.GET)
	public ModelAndView overview(ModelMap model, HttpServletRequest request, HttpServletResponse response)
			throws IOException, Exception {
		
		ModelAndView view = new ModelAndView();
		view.setViewName("view/overview");
		
		return view;
	}
	@RequestMapping(value = "/overview2.do", method = RequestMethod.GET)
	public ModelAndView overview2(ModelMap model, HttpServletRequest request, HttpServletResponse response)
			throws IOException, Exception {
		
		ModelAndView view = new ModelAndView();
		view.setViewName("view/overview2");
		
		return view;
	}
	@RequestMapping(value = "/publications.do", method = RequestMethod.GET)
	public ModelAndView publications(ModelMap model, HttpServletRequest request, HttpServletResponse response)
			throws IOException, Exception {
		
		ModelAndView view = new ModelAndView();
		view.setViewName("view/publications");
		
		return view;
	}
	@RequestMapping(value = "/quebec.do", method = RequestMethod.GET)
	public ModelAndView quebec(ModelMap model, HttpServletRequest request, HttpServletResponse response)
			throws IOException, Exception {
		
		ModelAndView view = new ModelAndView();
		view.setViewName("view/quebec");
		
		return view;
	}
	@RequestMapping(value = "/seattle.do", method = RequestMethod.GET)
	public ModelAndView seattle(ModelMap model, HttpServletRequest request, HttpServletResponse response)
			throws IOException, Exception {
		
		ModelAndView view = new ModelAndView();
		view.setViewName("view/seattle");
	...
	public void streamVideo(@PathVariable String fileName,
	    ...
	    File videoFile = new File(request.getServletContext().getRealPath("/img/pattern/content/") + fileName);
	    if (!videoFile.exists()) {
	    ...
	    try (RandomAccessFile raf = new RandomAccessFile(videoFile, "r");
	        ...
	        while (bytesLeft > 0) {
	            len = raf.read(buffer, 0, (int) Math.min(buffer.length, bytesLeft));
	            if (len == -1) break;

	            try {
	                out.write(buffer, 0, len);
	            } catch (IOException e) {
	                // 브라우저가 연결을 끊으면 안전하게 종료
	                break;
	            }
	        ...
	        // 로그에만 남기고 재생 실패는 무시
	        System.out.println("Stream aborted: " + e.getMessage());
	    }
	}
} 
