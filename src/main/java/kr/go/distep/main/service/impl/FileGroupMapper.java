...
public interface FileGroupMapper {
	//FILE_GROUP 테이블에 insert
		...
		public List<FileDetailVO> selectFilesByGroupNo(long fileGroupNo);

		public FileDetailVO selectFileById(long fileId);

		public void deleteFileById(long fileId);

		public int countFilesInGroup(long fileGroupNo);
		void deleteFilesByType(@Param("fileGroupNo") long fileGroupNo, @Param("fileType") String fileType);
