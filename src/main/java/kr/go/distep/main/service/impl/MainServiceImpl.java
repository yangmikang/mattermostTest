...
public class MainServiceImpl implements MainService{
	...
	@Override
	@Async
	public boolean sendMailWithAttachments(
	        String from, String to, String subject, String content, String userName, MultipartFile[] attachments) {

	    try {
	        boolean hasAttachments = attachments != null && attachments.length > 0 && Arrays.stream(attachments).anyMatch(f -> !f.isEmpty());

	        // 첨부 없으면 false, 있으면 true
	        ...
	        helper.setText("Sender Email: " + from + "<br/><br/>Message: " + content, true);
